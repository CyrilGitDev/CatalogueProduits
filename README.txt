...
j'utilise egalement Slugify qui necessite donc d'effectuer la commande "composer require cocur/slugify" pour generer des url
utilisation de "faker" pour generer des fixture aleatoire "composer require fzaninotto/faker" 
j'ai trouvé beaucoup d'explication alors j'ai utilisé faker il est simple et marche directement
...
Nous pouvons visualiser la page d'un bien en cliquant sur son titre un systeme de page à été mis en place
